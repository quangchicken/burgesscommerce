  ...
  <Layout>
    ...
    <>
      <main id="main" className="site-main">
                  ...
                  <div className="image">
                    <picture>
                      <source
                        ...
                        srcSet="images/full-portrait.png"
                      />
                      <source srcSet="images/full-portrait-mobile.png" />
                      <img
                        loading="lazy"
                        src="images/full-portrait.png"
                        alt=""
                      />
                    </picture>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-wide-4 col-small-3">
                    <picture>
                      ...
                      <img loading="lazy" src="images/bigcommerce.svg" alt="" />
                    </picture>
                  </div>
                  <div className="col-small-3 hide-for-desktop">
                    <picture>
                      ...
                      <img loading="lazy" src="images/wo-commerce.svg" alt="" />
                    </picture>
                  </div>
                </div>
              </div>
            ...
            <div className="row-flex row-flex-reverse row-flex-aligncenter">
              <div className="col-image">
                <picture>
                  ...
                  <img loading="lazy" src="images/thumbnail-rowan.png" alt="" />
                </picture>
              </div>
            ...
            <div className="row-flex row-flex-aligncenter">
              <div className="col-image">
                <picture>
                  ...
                  <img loading="lazy" src="images/cols2-banner-2.png" alt="" />
                </picture>
              </div>
              <div className="col-text text-dark">
                <div className="heading">
            ...
            <div className="row-flex row-flex-reverse row-flex-aligncenter">
              <div className="col-image">
                <picture>
                  ...
                  <img loading="lazy" src="images/cols2-banner-3.png" alt="" />
                </picture>
              </div>
              <div className="col-text text-dark">
                <div className="heading">
                ...
                <div className="content">
                  <p>
                    ...
                    help resource agencies on a professional level to help them
                    deliver high quality work at a fast pace without lowering
                    quailty expected.
                  </p>
                  <a href="#" className="button-text">
                    explore our projects{" "}
            ...
            <div className="row-flex row-flex-reverse row-flex-aligncenter">
              <div className="col-image">
                <picture>
                  ...
                  <img loading="lazy" src="images/cols2-banner-4.png" alt="" />
                </picture>
              </div>
              <div className="col-text text-dark">
                <div className="heading">
            ...
            <div className="row-flex row-flex-aligncenter">
              <div className="col-image">
                <picture>
                  ...
                  <img loading="lazy" src="images/cols2-banner-5.png" alt="" />
                </picture>
              </div>
              <div className="col-text text-dark">
                <div className="heading">
              ...
              <div className="row">
                ...
                <div className="col-image">
                  <picture>
                    ...
                    <img loading="lazy" src="images/image-mobile.jpg" alt="" />
                  </picture>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="content">
                  ...
                  <p>
                    ...
                    platforms and frameworks like Magento, Shopify, BigCommerce,
                    WordPress, and Laravel so that you can take your business to
        ...
        <section className="faqs margin-top padding-bottom padding-top line-bottom-left">
